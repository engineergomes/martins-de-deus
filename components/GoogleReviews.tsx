...
const GoogleReviews: React.FC = () => {
  ...
  return (
    <div
      className="flex flex-col gap-5 w-full items-center justify-center border-t border-[#CFAA7D] pt-12  bg-right pb-16"
      style={{ backgroundImage: `url('./bg-effect.png')` }}
    >
      <h2 className="text-3xl text-[#CFAA7D] font-bold">Nossos Clientes</h2>
      <div className="text-black w-full m-auto bg-transparent flex  justify-center">
        <Swiper
