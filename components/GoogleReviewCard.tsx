...
const GoogleReviewCard = ({ review }: GoogleReviewCardProps) => {
	return (
		<Link
			className="p-6 rounded-md shadow-md flex flex-col text-darkBlue border-2 border-transparent hover:border-[#CFAA7D] overflow-hidden z-[5] bg-[#FDFDFD] hover:bg-[#FDFDFD]/90 hover:backdrop-blur-lg
      w-full min-h-[192px]"
			target="_blank"
			href={review.href}
		>
