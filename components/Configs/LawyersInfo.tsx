export const lawyers = [
	{
		...
		about: "Manuela Martins é advogada, graduada pela Universidade do Vale do Itajaí, pós-graduada em Direito Civil pela Anhanguera, proprietária do Escritório Martins de Deus Advogados Associados, atuante nas áreas de Direito Civil, Direito de Família, Direito do Consumidor e Direito Imobiliário. Na prática da advocacia preza sempre pela ética, buscando prestar um atendimento humano e personalizado na busca do direito de seus clientes.",
	},
	// {
	// 	name: "SIBELLE LOHN",
	// 	imgSrc: "/img6.png",
	...
	// 	about: "Sibelle Lohn é advogada, graduada pela Universidade do Vale do Itajaí, associada do Escritório Martins de Deus Advogados Associados, atuante nas áreas de Direito Civil e Direito de Família com foco na atuação em defesa do direito das mulheres. Na prática da advocacia, preza por um atendimento humanizado, acolhedor e responsável, aplicando o direito de forma crítica, considerando as subjetividades humanas, sempre buscando entender a fundo a necessidade dos clientes de forma personalizada.",
	// },
	{
