export const lawyers = [
    ...
    },
    {
        ...
        about: "Sibelle Lohn é advogada, graduada pela Universidade do Vale do Itajaí, associada do Escritório Manuela Martins Advocacia, atuante nas áreas de Direito Civil e Direito de Família com foco na atuação em defesa do direito das mulheres. Na prática da advocacia, preza por um atendimento humanizado, acolhedor e responsável, aplicando o direito de forma crítica, considerando as subjetividades humanas, sempre buscando entender a fundo a necessidade dos clientes de forma personalizada.",
    },
    {
