        ...
        <div className="flex flex-col max-w-[1360px] mx-auto gap-10 items-center justify-center px-5">
          ...
          <div className="hidden lg:grid grid-cols-4 gap-10 place-items-center">
            {direitoDaFamilia.map((item, index) => (
              <div
                key={index}
                className="grid grid-cols-1 grid-rows-[1fr,1fr,1fr] gap-0 rounded p-5 lg:p-10 w-full h-full place-items-center bg-[#282828]
				 text-[#cfaa7d] fill-[#CFAA7D] border-4 border-[#cfaa7d] hover:border-[#CFAA7D] drop-shadow hover:drop-shadow-xl
