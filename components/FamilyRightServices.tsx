...
function FamilyRightServices() {
    ...
    return (
        <>
            <div className="flex flex-col max-w-[1360px] mx-auto gap-10 items-center justify-center">
                <h2 className="text-5xl font-bold text-center text-[#D3AC5C] max-w-full">
                ...
                <div className="grid grid-cols-4 gap-10 place-items-center">
                    {direitoDaFamilia.map((item, index) => (
                        <div
                            key={index}
                            className="grid grid-cols-1 grid-rows-[1fr,1fr,1fr] gap-0 drop-shadow-lg rounded border p-10 w-full h-full place-items-center"
                        >
                            <div className="h-24 w-24 fill-[#D3AC5C]">
                                {item.icon}
                            </div>
