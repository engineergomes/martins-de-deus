			...
			>
				<div className="max-w-[1360px] px-5 flex flex-col items-center justify-between h-full gap-4 lg:gap-6 pt-5 ">
					...
					<div className="lg:-mt-6 mt-7 flex items-end justify-center h-full w-full ">
						<div className="goldenEffect absolute w-full h-32 lg:h-1/2 z-0 opacity-40 bottom-0 left-0"></div>
						<div className="goldenEffect absolute w-full h-32 lg:h-1/2 z-10 opacity-20 bottom-0 left-0"></div>
						<Image
							data-aos="fade-left"
							src="/todos-no-background-4.webp"
							alt="Advogados"
							width={1400}
							height={800}
