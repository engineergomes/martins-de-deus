...
import TrabalhistaServices from "../components/TrabalhistaServices";
	...
	return (
		<>
			<Head>
				...
				/>
				<title>Martins de Deus | Direito Trabalhista</title>
						...
						<div className="flex flex-col gap-8 max-w-[600px] px-8 py-5 rounded-3xl opacity-95 z-20 sm:py-10">
							<div className="flex flex-col gap-4 max-w-3xl opacity-100">
								...
								<p className="text-xl md:text-2xl max-w-[40ch]">
									Receba agora um atendimento personalizado de
									uma advogada que atende causas de direito
									trabalhista todos os dias.
								</p>
							</div>
