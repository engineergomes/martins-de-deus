...
import { DivorciosExtraJudicial } from "../components/SVG/Icons";
...
const DireitoDaFamilia: NextPage = () => {
    return (
        <>
            ...
            <div className="flex flex-col gap-12 px-5 lg:grid lg:grid-cols-2 max-w-[1360px] mx-auto relative">
                ...
                <div className="w-full flex items-center justify-center absolute bottom-3 pt-10 ">
                    <a
                        href="#resultados"
                        className="h-full relative flex flex-col gap-2 justify-center items-center font-bold uppercase text-center text-xl z-20  w-min px-8 pb-14 pt-4 "
                    >
                ...
                <DivorciosExtraJudicial className="fill-blue-600" />
            </div>
        </>
    );
};
